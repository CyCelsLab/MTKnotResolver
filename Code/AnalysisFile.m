...
function [dataArray, endEndDistance] = AnalysisFile(resolveCoordinates, filePath,ScalingFactor,figurePath)
...
close all
    ...
    cb = colorbar;
    print(gcf, '-dpdf', fullfile(figurePath, sprintf("TangentAngleKymograph.pdf")),'-r600')
    ...
    xlabel('Time (s)')
    set(gca, 'FontSize', 14);
    print(gcf, '-dpdf', fullfile(figurePath, sprintf("End2End.pdf")),'-r600')
